                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="sanction_paid_amt" id="sanction_paid_amt" value="<?php echo $info['tom_approval_amt'];?>" placeholder="Enter Sanction Paid Amount" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
                </div>
                <!-- /.card-body -->
