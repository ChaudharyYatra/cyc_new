    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <a class="underline" href="<?php echo base_url(); ?>kitchen_staff_cook/tour_expenses/index">
          ...
          ?> 
          <div class="col-lg-3 col-6">
            <a class="underline" href="<?php echo base_url(); ?>kitchen_staff_cook/suggestion_module/index">
