                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php  
                   ...
                   { 
                    ...
                    <td><?php echo date("d-m-Y",strtotime($info['leave_start_date'])); ?></td>
                    <td><?php echo date("d-m-Y",strtotime($info['leave_end_date'])); ?></td>
                    <td><?php echo $info['leave_balanace']; ?></td>
                    <td><?php echo $info['leave_reason']; ?></td>
                    <td><?php echo $info['leave_approval_status'] ?></td>
