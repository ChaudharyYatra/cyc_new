              ...
              { ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Asset Identification Number</th>
                    <th>Purchase Date</th>
                    <th>Purchase Cost</th>
                    <th>Is Active?</th>
                    <th>Action</th>
                  ...
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $info['fixed_asset_name'] ?></td>
                    <td><?php echo $info['asset_category'] ?></td>
                    <td><?php echo $info['asset_identification_no'] ?></td>
                    <td><?php echo date("d-m-Y",strtotime($info['purchase_date'])); ?></td>
                    <td><?php echo $info['purchase_cost'] ?></td>
