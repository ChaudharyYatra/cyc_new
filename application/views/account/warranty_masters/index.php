                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php  
                   ...
                   { 
                    ...
                    <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $info['warranty_title']; ?></td>
                    <td><?php echo $info['warranty_description'] ?></td>
                    <td><?php echo $info['warranty_type']; ?></td>
                    <td><?php echo $info['warranty_duration'] ?></td>
                    <td><?php echo date("d-m-Y",strtotime($info['warranty_start_date'])); ?></td>
                    <td><?php echo date("d-m-Y",strtotime($info['warranty_end_date'])); ?></td>
