                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if($info['i_got_it']=='yes')
                        {
                      ?>
                      <button class="btn btn-success btn-sm" disabled><a class="i_got_it" href="<?php echo $module_url_path ?>/active_inactive/<?php $aid=base64_encode($info['id']); 
                        echo rtrim($aid, '=').'/'.$info['i_got_it']; ?>">YES</a></button>
                      <?php } else { ?>
