                ...
                <form method="post" enctype="multipart/form-data" id="seat_type_room_type">
                    <div class="card-body card-bg">
                        ...
                        <div class="card-footer">
                            ...
                            <button type="submit" class="btn btn-warning" name="submit_back" value="submit_back" id="back-button_seat_type">Back</button>
                            
                            <!-- <button type="submit" class="btn btn-warning" name="submit_back" value="submit_back" id="back-button"><a onclick="return confirm('Are You Sure You Want Save This Record?')">Back</a></button> -->
