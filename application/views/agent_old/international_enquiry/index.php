              ...
              { ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!-- <td>
                    ...
                    <!-- <td>
                    <a href="<?php //echo $module_url_path_international_followup;?>/index/<?php //echo $info['id']; ?>"><button type="button" class="btn btn-primary btn-sm btn_follow" class="dropdown-item">View</button></a>
                    </td> -->
