...
var structure = $(`<tr id="new_row${i}">
                    <td class="hotel_room_rate">
                        <select class="form-control" style="width: 100%;" name="ingredients_name[]" id="ingredients_name${i}" required="required">
                        <option value="">Select Ingredients</option>
                                <?php
                                foreach($ingredients_data as $ingredients_data_info) 
                                { 
                                ?>
                                <option value="<?php echo $ingredients_data_info['id'];?>"><?php echo $ingredients_data_info['ingredients'];?></option>
                                <?php } ?>
                        </select>
                    </td>
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="ingredient_quantity[]" id="ingredient_quantity${i}" oninput="this.value = this.value.replace(/[^0-9]/g, '');" placeholder="Enter Ingredients Quantity" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <select class="form-control" style="width: 100%;" name="ingredients_weight[]" id="ingredients_weight${i}" required="required">
                ...
                i++;
$('#ingredients_row').append(structure); 
});
...
<script>
        var i=1;
    $('#edit_add_more_ingredients').click(function() {
var structure = $(`<tr id="new_row${i}">
                    <td class="hotel_room_rate">
                        <select class="form-control" style="width: 100%;" name="edit_ingredients_name[]" id="edit_ingredients_name${i}" required="required">
                        <option value="">Select Ingredients</option>
                                <?php
                                foreach($ingredients_data as $ingredients_data_info) 
                                { 
                    ...
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="edit_ingredient_quantity[]" id="edit_ingredient_quantity${i}" oninput="this.value = this.value.replace(/[^0-9]/g, '');" placeholder="Enter Ingredients Quantity" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <select class="form-control" style="width: 100%;" name="edit_ingredients_weight[]" id="edit_ingredients_weight${i}" required="required">
                        <option value="">Select Weight</option>
                                <?php
                                foreach($measuring_unit_data as $measuring_unit_data_info) 
                                { 
...
<!-- add recipe module ->  Kitchen Equipment's -->
<script>
var i=1;
$('#add_more_equipment').click(function() {
    //   alert('hhhh');
var structure = $(`<tr id="new_row${i}">
                    <td class="hotel_room_rate">
                        <select class="form-control" style="width: 100%;" name="Equipment_name[]" id="Equipment_name${i}" required="required">
                        <option value="">Select Equipment</option>
                                <?php
                                foreach($kitchen_equipment_data as $kitchen_equipment_data_info) 
                                { 
                                ?>
                                <option value="<?php echo $kitchen_equipment_data_info['id'];?>"><?php echo $kitchen_equipment_data_info['kitchen_equipment_name'];?></option>
                                <?php } ?>
                        </select>
                    </td>
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="equipment_quantity[]" id="equipment_quantity${i}" oninput="this.value = this.value.replace(/[^0-9]/g, '');" placeholder="Enter room rate" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <select class="form-control" style="width: 100%;" name="equipment_weight[]" id="equipment_weight${i}" required="required">
                        <option value="">Select Weight</option>
                                <?php
                                foreach($measuring_unit_data as $measuring_unit_data_info) 
                                { 
                ...
                i++;
$('#Equipment_row').append(structure); 
});
...
<script>
var i=1;
$('#edit_add_more_equipment').click(function() {
    //   alert('hhhh');
var structure = $(`<tr id="new_row${i}">
                    <td class="hotel_room_rate">
                        <select class="form-control" style="width: 100%;" name="edit_Equipment_name[]" id="edit_Equipment_name${i}" required="required">
                        <option value="">Select Equipment</option>
                                <?php
                                foreach($kitchen_equipment_data as $kitchen_equipment_data_info) 
                                { 
                    ...
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="edit_equipment_quantity[]" id="edit_equipment_quantity${i}" oninput="this.value = this.value.replace(/[^0-9]/g, '');" placeholder="Enter room rate" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <select class="form-control" style="width: 100%;" name="edit_equipment_weight[]" id="edit_equipment_weight${i}" required="required">
                        <option value="">Select Weight</option>
                                <?php
                                foreach($measuring_unit_data as $measuring_unit_data_info) 
                                { 
...
<!-- add recipe module ->  recipe process -->
<script>
var i=1;
$('#add_more_recipe').click(function() {
    //   alert('hhhh');
var structure = $(`<tr id="new_row${i}">
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="recipe_steps[]" id="recipe_steps${i}" placeholder="Enter recipe steps" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="enter_recipe[]" id="enter_recipe${i}" placeholder="Enter recipe" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="recipe_quantity[]" id="recipe_quantity${i}" placeholder="Enter recipe quantity" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="recipe_require_time[]" id="recipe_require_time${i}" placeholder="Enter recipe require time" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <button type="button" name="remove" id="${i}" class="btn btn-danger btn_remove">X</button>
                    </td>
...
<script>
var i=1;
$('#edit_add_more_recipe').click(function() {
    //   alert('hhhh');
var structure = $(`<tr id="new_row${i}">
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="edit_recipe_steps[]" id="edit_recipe_steps${i}" placeholder="Enter recipe steps" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="edit_enter_recipe[]" id="edit_enter_recipe${i}" placeholder="Enter recipe" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="edit_recipe_quantity[]" id="edit_recipe_quantity${i}" placeholder="Enter recipe quantity" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <input type="text" class="form-control" name="edit_recipe_require_time[]" id="edit_recipe_require_time${i}" placeholder="Enter recipe require time" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required="required">
                    </td>
                    <td class="hotel_room_rate">
                        <button type="button" name="remove" id="${i}" class="btn btn-danger btn_remove">X</button>
                    </td>
...
<script>
    function calculateTotalWeight() {
        var packsNo = document.getElementById('packs_no').value;
        var perPlateQuantity = document.getElementById('per_plate_quantity').value;

        if (packsNo && perPlateQuantity) {
            var totalWeight = packsNo * perPlateQuantity;
