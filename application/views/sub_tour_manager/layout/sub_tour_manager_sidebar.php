    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <center><h6 class="desig_css">[ Sub Tour Manager ]</h6></center>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
                <a href="<?php echo base_url(); ?>sub_tour_manager/dashboard/index" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>sub_tour_manager/tour_expenses/index" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
               Tour expenses
              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>sub_tour_manager/asign_sub_tour_to_manager/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>My asigned tour</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>sub_tour_manager/tour_photos/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tour photos</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>sub_tour_manager/profile/index" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Profile
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>sub_tour_manager/change_password/change_password" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
              Change password
              </p>
