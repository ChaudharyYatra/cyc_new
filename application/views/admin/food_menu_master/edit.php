              ...
              <form method="post" enctype="multipart/form-data" id="edit_state">
                ...
                <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" style="width: 100%;" name="food_type" id="food_type" required="required">
                                ...
                                <?php
                                   ...
                                   { 
                                ?>
                                   <option value="<?php echo $food_type_info['id']; ?>" <?php if($food_type_info['id']==$info['food_type_id']) { echo "selected"; } ?>><?php echo $food_type_info['food_type_name']; ?></option>
                               <?php } ?>
                              </select>
                          </div>
                      </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="food_menu_name" id="food_menu_name" placeholder="Enter State Name" required="required" value="<?php echo $info['food_menu_name']; ?>">
                    </div>
                    </div>
                </div>
                <!-- /.card-body -->
