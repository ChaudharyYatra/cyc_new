              ...
              <form method="post" enctype="multipart/form-data" id="add_bus_kilometer_rates">
                <div class="card-body">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="rate_1" id="rate_1" placeholder="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="rate_2" id="rate_2" placeholder="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="rate_3" id="rate_3" placeholder="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="rate_4" id="rate_4" placeholder="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="rate_5" id="rate_5" placeholder="">
                          </div>
                        </div>
