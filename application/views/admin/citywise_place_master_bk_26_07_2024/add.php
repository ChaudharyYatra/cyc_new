                  ...
                  <div class="container" style="border: 1px solid #959595;padding: 1rem;">
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        ...
                        <table class="table table-bordered" style="width:100%" id="sector_table">
                          ...
                          <thead>
                              <tr style="background:#a19f9f; color:white;">
                                <th style="width:25%;">Enter Organization Name</th>
                                <th style="width:15%;">Select Designation</th>
                                <th style="width:15%;">Enter Person Name</th>
                                <th style="width:10%;">Enter Contact Number</th>
                                <th style="width:15%;">Enter Email</th>
                                <th style="width:15%;">Enter Address</th>
                                <th style="width:15%;">Enter Website URL</th>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="file" name="place_image" id="place_image" required="required" multiple>
                        ...
                        <div class="col-md-12">
                          <div class="row">
                            ...
                            <div class="col-md-2 mb-4">
                              <input type="radio" id="in_tour_creation_yes" name="in_tour_creation_no1" value="Yes" > &nbsp;
                              <label>Yes</label>  &nbsp; &nbsp; 
                              <input type="radio" id="in_tour_creation_no" name="in_tour_creation_no1" value="No" > &nbsp;
                              <label>No</label><br>
                            </div>
                            <div class="col-md-2 mb-4">
                            ...
                            <div class="col-md-3 mb-4">
                              <input type="text" class="form-control" name="ticket_cost[]" id="ticket_cost" placeholder="Enter Ticket Cost">
                            </div>
                            ...
                            <div class="col-md-2 mb-4">
                              <input type="radio" id="in_tour_creation_yes_1" name="in_tour_creation_no2" value="Yes" > &nbsp;
                              <label>Yes</label>  &nbsp; &nbsp; 
                              <input type="radio" id="in_tour_creation_no_1" name="in_tour_creation_no2" value="No" > &nbsp;
                              <label>No</label><br>
                            </div>
                            <div class="col-md-2 mb-4">
                            ...
                            <div class="col-md-2 mb-4">
                              <input type="radio" id="in_tour_creation_yes_2" name="in_tour_creation_no3" value="Yes" > &nbsp;
                              <label>Yes</label>  &nbsp; &nbsp; 
                              <input type="radio" id="in_tour_creation_no_2" name="in_tour_creation_no3" value="No" > &nbsp;
                              <label>No</label><br>
                            </div>
                            <div class="col-md-2 mb-4">
                            ...
                            <div class="col-md-2 mb-4">
                              <input type="radio" id="in_tour_creation_yes_3" name="in_tour_creation_no4" value="Yes" > &nbsp;
                              <label>Yes</label>  &nbsp; &nbsp; 
                              <input type="radio" id="in_tour_creation_no_3" name="in_tour_creation_no4" value="No" > &nbsp;
                              <label>No</label><br>
                            </div>
                            <div class="col-md-2 mb-4">
                            ...
                            <div class="col-md-2 mb-4">
                              <input type="radio" id="darshan_pass_cost_Yes" name="darshan_pass_cost_yes_no1" value="Yes" > &nbsp;
                              <label>Yes</label>  &nbsp; &nbsp; 
                              <input type="radio" id="darshan_pass_cost_No" name="darshan_pass_cost_yes_no1" value="No" > &nbsp;
                              <label>No</label><br>
                            </div>
                            <div class="col-md-3 mb-4">
