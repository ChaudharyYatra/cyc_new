                  ...
                  <?php  
                   ...
                   { 
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="<?php echo $module_url_path;?>/add/<?php echo $same_recipe_name_info['recipe_name']; ?>" ><button type="button" class="btn btn-primary">View Ingredients Compare Module</button></a>
                        </td>
                    </tr>
                    <?php $i++; } ?>
                  </tbody>
