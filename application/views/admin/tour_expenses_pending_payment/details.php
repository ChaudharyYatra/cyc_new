        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12">
            ...
            <?php
                   ...
                   { 
                    if($tour_expenses_all_info['tour_expenses_bill'] == '0'){
                     ?>
                ...
                <table id="" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <?php foreach($tour_expenses_image_all as $tour_expenses_image_all_info){ ?>
                        <?php if ($tour_expenses_image_all_info['tour_expenses_id'] == $tour_expenses_all_info['id']) { ?>
                ...
                <div class="accordion accordion-flush" id="accordion">
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                      <!-- <button class="btn btn-header-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> -->
                        <h6><b>Show Added Product Details</b></h6>
                      <!-- </button> -->
                    </h2>
                    <table class="table table-bordered table-bordered collapse show" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordion">
                      <thead>
                        <tr>
                          <th>Sr.No</th>
                          <!-- <th>Expense Head</th> -->
