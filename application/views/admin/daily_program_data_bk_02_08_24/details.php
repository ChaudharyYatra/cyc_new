                                        ...
                                        <tr>
                                            <td>
                                                <!-- <select class="select_css">
                                                    ...
                                                    <input readonly name="activity_type[]" id="activity_type" class="form-control" type="text" value="<?php echo $add_more_day_to_day_program_info['activity_type'];?>">
                                                <!-- </select> -->
                                            </td>
                                            <!-- <td>
                                            ...
                                            <td>
                                                <input disabled type="text" class="form-control quantity" name="start_point[]" id="start_point" value="<?php echo $add_more_day_to_day_program_info['start_place_name'];?>">
                                            </td>
                                            ...
                                            <td>
                                                <input disabled type="text" class="form-control quantity" name="start_point[]" id="start_point" value="<?php echo $add_more_day_to_day_program_info['end_place_name'];?>">
                                            </td>
                                ...
                                <table border="1" class="table table-bordered" id="table2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input disabled type="text" class="form-control quantity" name="to_place[]" id="to_place" value="<?php echo $add_more_day_to_day_program_info['end_place_name'];?>">
                                            </td>
                                            <td><input disabled type="time" class="form-control quantity" name="end_time[]" id="end_time<?php echo $i;?>" value="<?php echo $add_more_day_to_day_program_info['end_time'];?>"></td>
                                            <!-- <td>
