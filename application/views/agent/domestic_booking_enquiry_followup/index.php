        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="<?php echo $module_url_path_followup_already_taken; ?>/index"><button class="btn btn-primary">Back</button></a>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                       ...
                       <a data-bs-toggle="modal" data-bs-target="#bookingModal" data-bs-whatever="Form" data-enq-id="<?php echo $enq_id;?>"><button type="button" class="btn btn-primary btn-sm" class="dropdown-item">Book</button> </a>
                        <?php } ?>
                    </td>
                    <!-- <td>
                          ...
                          <div class="col-md-12">
                            <div class="row">
                              <div class="col-md-6 mb-2">
                                ...
                                <input type="hidden" name="enquiry_id" id="enquiry_id" value="<?php if(isset($info['booking_enquiry_id'])){ echo $info['booking_enquiry_id'];}?>">
                              </div>
