        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" enctype="multipart/form-data" id="add_QR_code_agent">
                <div class="card-body">
                 <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Full Name (As Per Bank Record)</label>
                            <input readonly type="text" class="form-control" name="full_name" id="full_name" value="<?php echo $agent_name['agent_name'];?>" placeholder="Enter Full Name" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');" required="required">
                        </div>
                    </div>
                ...
                <div class="card-footer">
                  <button type="button" class="btn btn-success" name="submit" value="edit_add_more_bank" id="edit_add_more_bank">Add More Bank Details</button>
