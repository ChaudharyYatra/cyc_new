                  ...
                  <tr>
                    ...
                    <?php 
                          if($info['received_qty']=='0' && $info['send_qty']!='')
                            {
                          ?>
                            <input type="number" name="received_qty[]" class="received_qty" id="received_qty" required />
                          <?php } else if($info['reject_status']=='yes') { ?>
                            <input type="number" name="received_qty[]" class="received_qty" id="received_qty" value="Order Rejected" readonly />
                           
                          <?php } else {?>
                            <input type="number" name="received_qty[]" class="received_qty" id="received_qty" placeholder="Not Sended" disabled />
                          <?php }?>
                    </td>
