                        ...
                        <div class="col-md-6">
                            ...
                            <table id="example2" class="table table-bordered table-hover table-striped">
                                ...
                                <tr id="payment_type_tr" style='display:contents;'>
                                    <th>Payment Type</th>
                                    <td>&nbsp;&nbsp;&nbsp;<input disabled type="radio" name="payment_type" id="payment_type" value="Advance" <?php if(!empty($booking_payment_details['payment_type'])){if("Advance" == $booking_payment_details['payment_type']) {echo 'checked';}}?>>&nbsp;&nbsp;Advance
                                    &nbsp;&nbsp;&nbsp;<input disabled type="radio" name="payment_type" id="payment_type" value="Part" <?php if(!empty($booking_payment_details['payment_type'])){if("Part" == $booking_payment_details['payment_type']) {echo 'checked';}}?>>&nbsp;&nbsp;Part
                                    &nbsp;&nbsp;&nbsp;<input disabled type="radio" name="payment_type" id="payment_type" value="Full" <?php if(!empty($booking_payment_details['payment_type'])){if("Full" == $booking_payment_details['payment_type']) {echo 'checked';}}?>>&nbsp;&nbsp;Full</td>
                                ...
                                <tr id="booking_amount_tr" style='display:table-row;'>
                                    ...
                                    <td>
                                    <input readonly type="text" class="form-control" name="booking_amt" id="booking_amt" placeholder="Enter booking amount" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['booking_amt'];} ?>" required onkeyup="validate()">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>Payment</th>
                                    <td>&nbsp;&nbsp;<input disabled type="radio" name="payment_now_later" id="payment_now_later" onchange='payment_otp(this.value);' value="Now" <?php if(!empty($booking_payment_details['payment_now_later'])){if("Now" == $booking_payment_details['payment_now_later']) {echo 'checked';}}?>>&nbsp;&nbsp;Now
                                        <!-- &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="payment_now_later" id="payment_now_later" onchange='payment_otp(this.value);' value="Later">&nbsp;&nbsp;Later -->
                                    </td>
                                    
                                </tr>
                                    <?php if($booking_payment_details['payment_now_later']== 'Now'){?>
                                <tr>
                                    <th>Payment Mode</th>
                                    <td>
                            ...
                            <?php if(isset($booking_payment_details['select_transaction']) && $booking_payment_details['select_transaction']=='Net Banking'){?>
                                ...
                                <div class="row cash_payment_div">
                                        ...
                                        <input disabled type="radio" name="netbanking_payment_type" id="netbanking_payment_type_neft" onchange="netpayment_validate()" value="NEFT"  <?php if(!empty($booking_payment_details['netbanking_payment_type'])){if("NEFT" == $booking_payment_details['netbanking_payment_type']) {echo 'checked';}}?>>&nbsp;&nbsp;NEFT
                                        &nbsp;&nbsp;&nbsp;&nbsp;<input disabled type="radio" name="netbanking_payment_type" id="netbanking_payment_type_rtgs" onchange="netpayment_validate()" value="RTGS" <?php if(!empty($booking_payment_details['netbanking_payment_type'])){if("RTGS" == $booking_payment_details['netbanking_payment_type']) {echo 'checked';}}?>>&nbsp;&nbsp;RTGS
                                        &nbsp;&nbsp;&nbsp;&nbsp;<input disabled type="radio" name="netbanking_payment_type" id="netbanking_payment_type_imps" onchange="netpayment_validate()" value="IMPS"  <?php if(!empty($booking_payment_details['netbanking_payment_type'])){if("IMPS" == $booking_payment_details['netbanking_payment_type']) {echo 'checked';}}?>>&nbsp;&nbsp;IMPS
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <input disabled type="text" class="form-control" name="net_banking_acc_no" id="net_banking_acc_no" onkeyup="netbank_accno_validate()" placeholder="Enter Account No" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['net_banking_acc_no'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <input disabled type="text" class="form-control" name="net_banking_utr_no" id="net_banking_utr_no" onkeyup="netbank_utr_no_validate()" placeholder="Enter UTR No" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['net_banking'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <input disabled type="text" class="form-control" name="netbanking_bank_name" id="netbanking_bank_name" onkeyup="netbank_bank_nm_validate()" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['netbanking_bank_name'];}?>" placeholder="Enter Bank Name" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');">
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <input disabled type="date" class="form-control" name="netbanking_date" id="netbanking_date" onchange="netbank_date_validate()" placeholder="" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['netbanking_date'];}?>">
                                        </div>
                                    <!-- </div> -->
                                </div>
                            </div>
                            ...
                            <?php if(isset($booking_payment_details['select_transaction']) &&$booking_payment_details['select_transaction'] == 'UPI'){?>
                                ...
                                <div class="row cash_payment_div">
                                    ...
                                    <div class="col-md-6">
                                        <select disabled class="select_css"  name="select_upi_no" id="select_upi_no" required="required" onchange="transaction_upi_validate()">
                                        <!-- onchange='upi_QR_details(this.value); this.blur();' -->
                                            <option value="">Select UPI ID Holder Name</option>
                                            <option class="self_upi" attr_self="self" value="Self" <?php if(!empty($booking_payment_details['UPI_holder_name'])){if("Self" == $booking_payment_details['UPI_holder_name']) {echo 'selected';}}?>>Self</option>
                                            <?php
                                    ...
                                    <!-- <div id="upi_no_reason_div" style='display:none;'> -->
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <select disabled class="select_css" name="upi_payment_type" id="upi_payment_type" onchange="payment_type_validate()">
                                                <option value="">Select Transaction</option>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <input disabled type="text" class="form-control" name="upi_no" id="upi_no" onkeyup="utr_no_validate()" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['UPI_transaction_no'];}?>" placeholder="Enter Transaction Number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <input disabled type="text" class="form-control" name="reason" id="reason" onkeyup="reason_validate()" placeholder="Enter Reason" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['UPI_reason'];}?>" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');">
                                        </div>
                                    <!-- </div> -->
                                </div>
                            </div>
                            ...
                            <div class="" id="rq_div">
                                <div class="row cash_payment_div">
                                    ...
                                    <div class="col-md-6">
                                        <select disabled class="select_css" name="select_qr_upi_no" id="select_qr_upi_no" required="required" onchange="qr_hoder_name_validate()">
                                        <!-- onchange='upi_QR_details(this.value); this.blur();' -->
                                            <option value="">Select UPI ID Holder Name</option>
                                            <option value="Self" <?php if(!empty($booking_payment_details['UPI_holder_name'])){if("Self" == $booking_payment_details['UPI_holder_name']) {echo 'selected';}}?>>Self</option>
                                            <?php
                                                foreach($upi_qr_data as $upi_qr_data_value) 
                                                { 
                                            ?>
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <input readonly type="text" class="form-control" name="qr_mobile_number" id="qr_mobile_number" onkeyup="qr_mobile_no_validate()" placeholder="Enter Mobile Number" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['QR_mobile_number'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <select disabled class="select_css" name="qr_payment_type" id="qr_payment_type" onchange="qr_payment_type_validate()">
                                            <option value="">Select Transaction</option>
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <input disabled type="text" class="form-control" name="qr_upi_no" id="qr_upi_no" onkeyup="qr_utr_no_validate()" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['QR_transaction_no'];}?>" placeholder="Enter Transaction Number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                    </div>
                            ...
                            <?php if(isset($booking_payment_details['select_transaction']) && $booking_payment_details['select_transaction'] == 'Cheque'){?>
                                ...
                                <div class="row cash_payment_div">
                                    ...
                                    <div class="col-md-6">
                                        <input disabled type="text" class="form-control" name="cheque" id="cheque" onkeyup="cheque_no_validate()" placeholder="Enter Cheque Number" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cheque'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <input disabled type="text" class="form-control" name="bank_name" id="bank_name" onkeyup="cheque_banknm_validate()" placeholder="Enter Bank Name" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['bank_name'];}?>" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');">
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <input disabled type="date" class="form-control" name="drawn_on_date" id="drawn_on_date" onchange="cheque_date_validate()" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['drawn_on_date'];}?>" placeholder="Select Date">
                                    </div>
                                </div>
                            </div>
                            <?php } else{ ?>
                        ...
                        <?php if(isset($booking_payment_details['select_transaction']) && $booking_payment_details['select_transaction'] == 'CASH'){?>
                            ...
                            <div class="col-md-6">
                                <div class="row cash_payment_div">
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="500" name="cash_500" id="cash_500" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_500'];}?>" placeholder="Enter Particulars" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="200" name="cash_200" id="cash_200" placeholder="Enter Particulars" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_200'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="100" name="cash_100" id="cash_100" placeholder="Enter Particulars" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_100'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="50" name="cash_50" id="cash_50" placeholder="Enter Particulars" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_50'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="20" name="cash_20" id="cash_20" placeholder="Enter Particulars" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_20'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="10" name="cash_10" id="cash_10" placeholder="Enter Particulars" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_10'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="5" name="cash_5" id="cash_5" placeholder="Enter Particulars" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_5'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="2" name="cash_2" id="cash_2" placeholder="Enter Particulars" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_2'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <input readonly type="text" class="form-control data_amt" attr-amt="1" name="cash_1" id="cash_1" placeholder="Enter Particulars" value="<?php if(!empty($booking_payment_details)){ echo $booking_payment_details['cash_1'];}?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                        </div>
                                        <div class="col-md-1">
                                            =
                                        </div>
