                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="staff_paid_amt" id="staff_paid_amt" value="<?php echo $info['staff_fund_sending_amt'];?>" placeholder="Enter Agent Paid Amount" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
