              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Sanction Amount From TOM</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <?php if($info['Agent_send']=='yes'){?>
                        <div class="dropdown-menu" role="menu">
                          <a href="<?php echo $module_url_path;?>/view/<?php echo $info['id'];?>" class="dropdown_css"><button class="dropdown-item">View</button></a>
                        </div>
                        <?php } else {?>
                        <div class="dropdown-menu" role="menu">
                          <a href="<?php echo $module_url_path;?>/add/<?php echo $info['id'];?>" class="dropdown_css"><button class="dropdown-item">Amount Paid To Particular TM</button></a>
                        </div>
                        <?php } ?>
                      </div>
                    </td>
