    ...
    // alert('nnnnnnnnnnnnn');
        ...
        if(attr_partial_payment_type =='partial')
            ...
            $.ajax({
                ...
                method: 'post',
                data: {selectedPaymentType: selectedPaymentType,upi_holder_name:upi_holder_name},
                dataType: 'json',
                success: function(response){
                    // console.log(response);
                ...
                console.log(response);
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $("#submit_otp").prop('disabled', true);
                            if(receipt_type == 'SRA'){
                            window.location.href = "<?=base_url() ?>agent/sra_payment_receipt/index_pending/"+sra_no+ "/" +academic_year+ "/"+inserted_id;
                            }else{
                            window.location.href = "<?=base_url() ?>agent/sra_all_payment_details/index";
                            }
                        }
                    });
                } else {
