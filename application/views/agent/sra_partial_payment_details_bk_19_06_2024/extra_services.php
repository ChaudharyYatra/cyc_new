              ...
              <?php foreach($traveller_booking_info_header as $traveller_booking_info_value) 
                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tr>
                            <td>Special Request Master</td>
                            <td>"Special Request Master: Navigate here to include new Special Request for Extra Services above the 'Extra Services' option."</td>
                            <td>
