                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <?php if($info['tour_manager_id']!=''){?>
                            <a href="<?php echo $tour_expenses_module_url_path;?>/all_expenses/<?php $aid=base64_encode($info['package_id']); 
                                echo rtrim($aid, '='); ?>/<?php $did=base64_encode($info['package_date_id']); 
                                echo rtrim($did, '='); ?>/<?php $did=base64_encode($info['tour_manager_id']); 
                                echo rtrim($did, '='); ?>" class="itinerary_css"><button class="dropdown-item">View All Expenses</button>
                            </a>
                        <?php }else if($info['sub_tour_manager_id']!=''){ ?> 
                            <a href="<?php echo $tour_expenses_module_url_path;?>/all_expenses/<?php $aid=base64_encode($info['package_id']); 
                                echo rtrim($aid, '='); ?>/<?php $did=base64_encode($info['package_date_id']); 
                                echo rtrim($did, '='); ?>/<?php $did=base64_encode($info['sub_tour_manager_id']); 
                                echo rtrim($did, '='); ?>" class="itinerary_css"><button class="dropdown-item">View All Expenses</button>
                            </a>
                        <?php } ?>
