                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                              <div class="form-group">
                                ...
                                &nbsp;&nbsp;<input type="radio" name="payment_status" id="male" value="Received" <?php if(isset($info['request_status'])){if("Received" == $info['request_status']) {echo 'checked';}}?>>&nbsp;&nbsp;Received
                                &nbsp;&nbsp;<input type="radio" name="payment_status" id="female" value="Not Received" <?php if(isset($info['request_status'])){if("Not Received" == $info['request_status']) {echo 'checked';}}?>>&nbsp;&nbsp;Not Received <br>
                              </div>
                      </div>
