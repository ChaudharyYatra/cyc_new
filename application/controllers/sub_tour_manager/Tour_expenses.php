...
class Tour_expenses extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/tour_expenses";
        ...
        $this->db->where('tour_expenses.sub_tour_manager_id',$id);
        ...
        $this->db->join("assign_staff", 'tour_expenses.sub_tour_manager_id=assign_staff.name','left');
