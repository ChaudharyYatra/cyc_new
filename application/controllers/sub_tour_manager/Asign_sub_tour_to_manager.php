...
class Asign_sub_tour_to_manager extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/asign_sub_tour_to_manager";
        $this->module_url_path_instruction    =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/instruction_module";
        $this->module_url_tour_photos    =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/tour_photos";
		$this->module_satff_advance_payment    =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/staff_advance_payment";
        $this->module_url_path_request_more_fund   =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/tm_request_more_fund";
        $this->module_url_path_tour_expenses    =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/tour_expenses";
        $this->module_url_path_customer_feedback   =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/customer_feedback";
        $this->module_url_path_request_replace_bus   =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/request_replace_bus";
        $this->module_title       = "Asign Tour";
        $this->module_url_slug    = "asign_sub_tour_to_manager";
        $this->module_view_folder = "asign_sub_tour_to_manager/";    
