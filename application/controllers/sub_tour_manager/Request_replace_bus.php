...
class Request_replace_bus extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/request_replace_bus";
        $this->module_url_path_asign_tour_to_manager    =  base_url().$this->config->item('sub_tour_manager_panel_slug')."sub_tour_manager/asign_tour_to_manager";
