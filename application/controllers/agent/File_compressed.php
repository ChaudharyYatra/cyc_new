...
class File_compressed extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_panel_slug')."/file_compressed";
        $this->module_title       = "File Compressed";
        $this->module_url_slug    = "file_compressed";
        $this->module_view_folder = "file_compressed/";    
