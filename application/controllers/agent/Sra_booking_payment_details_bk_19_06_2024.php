...
class Sra_booking_payment_details extends CI_Controller {
    ...
    { 
        ...
        $id=$this->session->userdata('agent_sess_id');
            ...
            $sra_booking_payment_details_sra_payment_id = $booking_payment_details_info['sra_payment_id']; 
            ...
            if($booking_payment_details_info !=''){
                ...
                $sra_final_booking_id = $final_booking_details['id']; 
                

                if(!empty($final_booking_details)){
                    $sra_final_booking_id = $final_booking_details['id']; 
                
                $arr_where     = array("sra_no" => $sra_no,"sra_payment_id" => $sra_booking_payment_details_sra_payment_id,"id" => $sra_final_booking_id);
                ...
                // print_r($arr_update); die;
                $arr_where     = array("sra_no" => $sra_no,"sra_payment_id" => $sra_booking_payment_details_sra_payment_id);
