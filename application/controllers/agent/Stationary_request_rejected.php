...
class Stationary_request_rejected extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_panel_slug')."/Stationary_request_rejected";
        $this->module_title       = "Stationary Order Rejected";
        $this->module_url_slug    = "Stationary_request_rejected";
        $this->module_view_folder = "stationary_request_rejected/";
        $this->arr_view_data = [];
	 }
