...
class Agentwise_enquiry_report extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('admin_panel_slug')."admin/agentwise_enquiry_report";
        $this->module_title       = "Agent Wise Enquiry Report";
        $this->module_url_slug    = "agentwise_enquiry_report";
        $this->module_view_folder = "agentwise_enquiry_report/";
        $this->arr_view_data = [];
	 }
