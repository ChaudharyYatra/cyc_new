...
class Sra_all_payment_details extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('admin_panel_slug')."/sra_all_payment_details";
        $this->module_url_agentwise_report    =  base_url().$this->config->item('admin_panel_slug')."/sra_agentwise_report";
	...
	public function index($agent_id)
	{
       ...
       // print_r($iid); die;
        ...
        $this->db->where('sra_booking_payment_details.is_deleted','no');
        $this->db->where('sra_booking_payment_details.agent_id',$agent_id);
        ...
        $this->arr_view_data['module_url_agentwise_report'] = $this->module_url_agentwise_report;
...
//        $traveller_booking_info_header = $this->master_model->getRecords('sra_payment');
        ...
        $this->db->where('is_deleted','no');
        $this->db->where('sra_booking_payment_details.sra_payment_id',$sra_pay_id);
        $this->db->group_by('sra_booking_payment_details.agent_id');
        $booking_payment_details_all_agent_id = $this->master_model->getRecord('sra_booking_payment_details');
        // print_r($booking_payment_details_all_agent_id); die;
        ...
        $this->arr_view_data['booking_payment_details_all_agent_id']        = $booking_payment_details_all_agent_id;
        $this->arr_view_data['page_title']      = $this->module_title." List";
        // $this->arr_view_data['module_pending_amt'] = $this->module_pending_amt;
        $this->arr_view_data['module_title']    = $this->module_title;
        $this->arr_view_data['module_url_path'] = $this->module_url_path;
