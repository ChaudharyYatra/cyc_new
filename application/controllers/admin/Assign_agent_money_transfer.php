...
class Assign_agent_money_transfer extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('admin_panel_slug')."/assign_agent_money_transfer";
        $this->module_title       = "Agent to Agent Money Trasfer";
        $this->module_url_slug    = "assign_agent_money_transfer";
        $this->module_view_folder = "assign_agent_money_transfer/";
	}
