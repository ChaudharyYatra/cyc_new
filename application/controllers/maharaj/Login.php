...
class Login extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('maharaj_panel_slug')."maharaj/login";
		$this->module_url_path_dashboard    =  base_url().$this->config->item('maharaj_panel_slug')."maharaj/dashboard";
        $this->module_url_path_supervision    =  base_url().$this->config->item('maharaj_panel_slug')."maharaj/login";
