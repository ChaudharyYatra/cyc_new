...
//        $traveller_booking_info_header = $this->master_model->getRecords('sra_payment');
        ...
        { 
            $sra_total_amount = $info['final_amt']; 
        }

        $fields = "extra_services_booking_payment_details.*,special_req_master.service_name,sra_extra_services.services_amt";
        ...
        $this->db->join("special_req_master", 'extra_services_booking_payment_details.sra_extra_services_id=special_req_master.id','left');
