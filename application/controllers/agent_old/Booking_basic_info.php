...
class Booking_basic_info extends CI_Controller {
	...
	function __construct() {
        ...
        $this->seat_checker  =  base_url().$this->config->item('agent_panel_slug')."/seat_checker";
    ...
    {  
        ...
        if($this->input->post('submit_back'))
        {
                ...
                //  print_r($arr_insert); die;
                 ...
                 {
                     $this->session->set_flashdata('success_message',ucfirst($this->module_title)." Added Successfully.");
                     redirect($this->seat_checker.'/index/'.$iid);
                 }
                 else
                 {
                     $this->session->set_flashdata('error_message',"Something Went Wrong While Adding The ".ucfirst($this->module_title).".");
         ...
         $this->arr_view_data['agent_sess_name'] = $agent_sess_name;
         $this->arr_view_data['seat_checker'] = $this->seat_checker;
