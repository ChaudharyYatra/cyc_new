...
class All_traveller_info extends CI_Controller {
	...
	function __construct() {
        ...
        {   
            ...
            $this->db->where('is_deleted','no');
            $courtesy_titles_data = $this->master_model->getRecords('courtesy_titles');
            // print_r($relation_data); die;
                ...
                //  $this->form_validation->set_rules('email_id', 'email id', 'required');
                    ...
                    $c=count($first_name);
                     ...
                     if($inserted_id > 0)
                     {
                         ...
                         redirect($this->domestic_booking_process.'/index/'.$iid);
                     }
                     else
                     {
        ...
        // echo ($all_traveller_info_tble_id ); die;
         ...
         $this->arr_view_data['courtesy_titles_data'] = $courtesy_titles_data;
