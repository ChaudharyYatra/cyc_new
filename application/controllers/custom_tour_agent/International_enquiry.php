...
class International_enquiry extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('custom_tour_agent_panel_slug')."custom_tour_agent/international_enquiry";
        $this->module_url_path_international_followup    =  base_url().$this->config->item('custom_tour_agent_panel_slug')."custom_tour_agent/international_booking_enquiry_followup";
