...
class Customer_cancelled_tour extends CI_Controller {
	...
	function __construct() {
     ...
     public function index()
     {
        ...
        $arr_data2 = $this->master_model->getRecords('confirm_booking',array('confirm_booking.is_deleted'=>'no'),$fields);    
         ...
         $data = array('middle_content' => 'customer_cancelled_tour',
						...
						'page_title'    => 'Customer Cancelled Tour'
						);
        $this->arr_view_data['page_title']     =  "Customer Cancelled Tour";
        $this->arr_view_data['middle_content'] =  "customer_cancelled_tour";
