        ...
        if($this->input->post('submit_doc'))
        {
              ...
              $file_name_courier_receipt =  $this->config->item('project_name').round(microtime(true)).str_replace(' ','_',$file_name['name']);
               ...
               $count=count($order_detail_id);
				...
				$message="Thank you!, Today we have despatch the stationary items order $mobileNumber. Your order will be reach in 3 working days.Regards,CYCPL Team.";
                $senderId  = "CYCPLN";
                
                $apiurl = "http://sms.sumagoinfotech.com/api/sendhttp.php?authkey=394685AG84OZGHLV0z6438e5e3P1&mobiles=$mobileNumber&message=$message&sender=CYCPLN&route=4&country=91&DLT_TE_ID=1207168251614585980";
