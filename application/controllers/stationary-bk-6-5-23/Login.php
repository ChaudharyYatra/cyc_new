...
class Login extends CI_Controller{
    ...
    {   
        ...
        {
            $this->form_validation->set_rules('stationary_email', 'Email Login', 'required');
            ...
            {
                $Email_login = $this->input->post('stationary_email');
                //$mobile_number1 = $this->input->post('mobile_number1');
                $Pass_login = $this->input->post('pass_login');   
                
              $this->db->where('stationary_email',$Email_login);
              ...
              $arr_data = $this->master_model->getRecords('stationary_login');       
                ...
                else
                {
                    ...
                    {
                        $this->session->set_userdata('stationary_email',$stationary_data['stationary_email']);
