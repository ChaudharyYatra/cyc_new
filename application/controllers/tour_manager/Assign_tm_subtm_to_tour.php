...
class Assign_tm_subtm_to_tour extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('tour_manager_panel_slug')."tour_manager/assign_tm_subtm_to_tour";
        $this->add_more_module_url_path    =  base_url().$this->config->item('tour_manager_panel_slug')."tour_manager/add_more_tour_expenses";
        $this->tour_expenses_module_url_path    =  base_url().$this->config->item('tour_manager_panel_slug')."tour_manager/tour_expenses";
        $this->module_title       = "Daily Tour Expenses";
        $this->module_url_slug    = "assign_tm_subtm_to_tour";
        $this->module_view_folder = "assign_tm_subtm_to_tour/";
        ...
        $this->module_title_tour_expenses       = "Daily Tour Expenses";
        $this->module_url_slug_tour_expenses    = "tour_expenses";
        $this->module_view_folder_tour_expenses = "tour_expenses/";
        $this->arr_view_data = [];
	}

        public function index($p_id,$pd_id)
        {
        ...
        package_type.package_type,package_date.journey_date,package_date.id as did,supervision.supervision_name,role_type.role_name";
        ...
        $this->db->join("assign_staff", 'tour_expenses.tour_manager_id=assign_staff.name OR tour_expenses.sub_tour_manager_id=assign_staff.name','left');
        ...
        $this->db->group_by('tour_expenses.tour_manager_id,tour_expenses.sub_tour_manager_id');
        ...
        $this->arr_view_data['tour_expenses_module_url_path'] = $this->tour_expenses_module_url_path;
        ...
        $this->arr_view_data['page_title']      = $this->module_title_tour_expenses." List";
        $this->arr_view_data['module_title']    = $this->module_title_tour_expenses;
        $this->arr_view_data['tour_expenses_module_url_path'] = $this->tour_expenses_module_url_path;
        $this->arr_view_data['middle_content']  = $this->module_view_folder_tour_expenses."all_expenses";
        $this->load->view('tour_manager/layout/agent_combo',$this->arr_view_data);
