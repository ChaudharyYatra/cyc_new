                    ...
                    else if (this.status() == 'selected') 
                    {
                        ...
                        if(selected_cls.indexOf(check_str)!=-1)
                        {
                            ...
                            else if(this.settings.label!='1')
                            {
                                ...
                                {    
                                    alert('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx');
...
//     var total_seat_count = parseInt(first_cls_cnt) + parseInt(second_cls_cnt) + parseInt(economy_cls_cnt) + parseInt(fourth_cls_cnt);
//     // var total_seat_count = parseInt(first_cls_cnt);
...
//         }
//     }
// // console.log('abcabcabcabcabcabcabcabcabcabcabcabcabcabc',abc);
//     var xyz = [];
//     for (var j = 1; j <= total_seat_count; j++) {
//         var j_string = j.toString();
...
//     var three_array= ['3','6','9','12','15','18','21','24','27','30'];
//     console.log('>>>>>>>>>>>>>>>>>>>>>>>>>>>>',final_filtered_a);

//     var myString = "";
//     myString += 'a_';
//     for (var i = 0; i < final_filtered_a.length; i++) {
//         // alert('wwwwwwwwwwwwwwwwwwwwwwwwwww');
...
//             if($.inArray(i_string, three_array) != '-1')
//             {
//                 myString += "_";
...
//             myString += "";
//         }
//         // console.log('qqqqqqqqqqqqqqq myString',myString);
...
//             if($.inArray(i_string, three_array) != '-1')
//             {
//                 console.log('pppppppppppppppppppp 444444444444444',i);
//                 myString += "_";
//             console.log('qqqqqqqqqqqqqqq myString',myString);
