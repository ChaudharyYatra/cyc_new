...
// }
            ...
            sc = $('#bus-seat-map').seatCharts({
                ...
                click: function() {
                    ...
                    } else if (this.status() == 'available') 
                    {
                        ...
                        var check_str_economy='window-economy-class';
                        var check_str_fourth='window-fourth-class';
                        ...
                        { 
                            ...
                            }else if(click_id!=1)
                            {
                                ...
                                if(seat_type.indexOf(check_str_economy)==-1)
                                {
                                ...
                                }else if(seat_type.indexOf(check_str_economy)!=-1)
                                {
                    ...
                    else if (this.status() == 'selected') 
                    {
                        ...
                        if(selected_cls.indexOf(check_str)!=-1)
                        {
                            ...
                            else if(this.settings.label!='1')
                            {
                                ...
                                if(selected_cls.indexOf(check_str_economy)==-1)
                                {    
                                ...
                                }else if(selected_cls.indexOf(check_str_economy)!=-1)
                                {
                                            ...
                                            && current_cls.indexOf(check_str)!=-1 && $.inArray('available', current_next_cls_array) != '-1')
                                    {
                                        ...
                                        console.log('abcdefghijklmopqrstuvwxyz',recalculateTotal(sc,click_id,selection_array));
    ...
    function recalculateTotal(sc,click_id='',selection_array='') {
                ...
                sc.find('selected').each(function() {
                    var selected_cls= this.data().classes;
    console.log('selected_cls',selected_cls);
                    var current_seat_number_id=this.settings.label;
                    var prev_seat_number_id = this.settings.label-1;
                    var next_seat_number_id = parseInt(this.settings.label)+1;
                    ...
                    && selected_cls!='window-economy-class')
                    {
                        ...
                        if(selected_cls.indexOf(check_str)!=-1)
                        {
                            ...
                            else if(this.settings.label!='1')
                            {
                                ...
                                if(selected_cls !='window-economy-class')
                                {    
                                    ...
                                    if(click_id == current_seat_number_id && $.inArray('available', current_prev_cls_array) != '-1' 
                                    && current_prev_cls.indexOf(check_str)==-1)
                                    {   
                                        alert('already selected 1');
                                        $("[attr_win_remove=win_" + this.settings.id + "]").remove();
                                        selection_array.splice($.inArray(click_id, selection_array), 1);
                                        total += parseInt(this.data().price);
                                        total += parseInt(this.data().attr_win);

                                    }else if(click_id == prev_seat_number_id && $.inArray('focused', current_prev_cls_array) != '-1' 
                                            && current_prev_cls.indexOf(check_str)==-1)
                                    {   
                                        alert('already selected 2');
                                        $("[attr_win_remove=win_" + this.settings.id + "]").remove();
                                        selection_array.splice($.inArray(click_id, selection_array), 1);
                                        total += parseInt(this.data().price);
                                    ...
                                    {   
                                        alert('already selected 12');
                                        total += parseInt(this.data().price);    
                                        total += parseInt(this.data().attr_win);
                                    } 
                                }
                                else if(selected_cls=='window-economy-class')
                                {
                                    alert('window economy class');
                                    if(click_id == current_seat_number_id && $.inArray('selected', current_next_cls_array) != '-1' 
                                    && current_prev_cls.indexOf(check_str)!=-1 && current_next_cls_array.indexOf(check_str)!=-1)
                                    {   
                                        // economy_cls_reduced_amt= parseInt(-this.data().price)+parseInt(this.data().attr_win);
                                        total -= parseInt(this.data().price);    
                                        total += parseInt(this.data().attr_win);
