        ...
        var $cart = $('#selected-seats'),
            ...
            sc = $('#bus-seat-map').seatCharts({
                ...
                click: function() {
                    ...
                    console.log(this.status() == 'available');
...
console.log('scscscscscscscscscscscscscscscscscscscscscscscscscscscscscscscscsc',sc.status);
                        // हा कोड सीट सिलेक्ट करताना विंडो सीट आहे का हे चेक क्रय साठी  वापरला आहे =================================================================================================
                    ...
                    // this.status('available');
                                    ...
                                    console.log('aaaaaaaaaasssssssssssssssssssddddddddddddddddddddddddd',sc.status(this.settings.id, 'available'));
                    ...
                    // this.status('available');
                                    ...
                                    sc.status(this.settings.id, 'available');
                                    console.log('fffffffffffffffvvvvvvvvvvvvvvvvvvvvvvvvvvvvggggggggggggggggggggggggg',sc.status(this.settings.id, 'available'));

                                }
                                console.log('22222222222222222222222222222222222222222222222222222222222222222',this.status());
                            }
                            //हा कोड सिलेक्ट केलेलं विंडो सीट हे १ नंबरच सीट नाही का हे चेक करण्या साठी वापरलं आहे
